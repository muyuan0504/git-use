...
module.exports = {
  ...
  /** rules配置标准格式： name + [配置数组]；
   *  配置数组的第一项表示level，可选0-disable, 1-warning, 2-error;
   *  第二项表示是否应用，可选 always | never
   *  第三项表示该rule的值
   */
  rules: {
    "type-enum": [2, "always", ["feat", "fix"]], // type可枚举选项
    "type-empty": [2, "never"], // <type> 不能为空
    // 'type-case': [2, 'always', 'lower-case'], // <type>格式小写
    "type-case": [0],
    "scope-empty": [0], // 'scope-case': [2, 'always', 'lower-case'], // <scope> 格式 小写
    "scope-case": [0],
